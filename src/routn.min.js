...
return false;}
var useHashForRouting=true,registeredRoutes={},routesWithoutHistory={};return{setup:function(options){var useHash=options.useHash||true;useHashForRouting=useHash==undefined?true:useHash;return this;},navigateAway:function(url){document.location.href=url;return this;},navigateTo:function(url,data){var path=getRoutePath(url).path;transitionTo(url,path,data);return this;},register:function(){var routesIn=(arguments&&arguments[0]&&(arguments[0][0]instanceof Array))?arguments[0]:(Array.prototype.slice.apply(arguments));if(!routesIn||!routesIn.length){console.log("No routes found");return;}
...
return this;}
return new function(){var _this=this,dummy,historySupported=!!(window.history&&window.history.pushState&&window.history.replaceState&&window.onpopstate);if(!historySupported){dummy=function(){return _this};console.log("routn works only with browsers that support HTML5 history APIs");}
