...
function getRegisterArgs(routeInfo){var keepHistory=true,constraint;if(!!routeInfo){var arg1=routeInfo[1],arg1Type=typeof(arg1);if(arg1Type==='object'){constraint=arg1;}else if(arg1Type==='boolean'){keepHistory=arg1;}
if(routeInfo.length>2){var arg2=routeInfo[2],arg2Type=typeof(arg2);if(arg2Type==='object'){constraint=arg2;}else if(arg2Type==='boolean'){keepHistory=arg2;}}}
